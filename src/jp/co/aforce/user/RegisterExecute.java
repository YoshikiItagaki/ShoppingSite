...
public class RegisterExecute extends Action {
	...
	public String execute(HttpServletRequest request, HttpServletResponse response) throws Exception {
		...
		Customer customer=dao.check(last_name, first_name, sex,
				birth_year, birth_month, birth_day,
				address, phone_number, email, password);

		if(customer!=null) {
			return "views/register-confirmation-error.jsp";
		...
		//2.3 登録されたことを確認
		if (line==0) {
			return "views/register-error.jsp";
		}

		return "views/register-out.jsp";
	}
