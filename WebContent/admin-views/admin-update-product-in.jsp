	...
	<div class="middle-container">
		...
		<div class="input-container">
			...
			<form method="post" name="form" class="form"
				action="<%=request.getContextPath()%>/jp.co.aforce.admin.FileUpload"
				enctype="multipart/form-data">
				<input type="file" name="image" id="uploader">
				<input 	type="submit" value="写真を追加" class="upload-button">
			</form>
			...
			<img src="<%=request.getContextPath()%>/img/<%=file_name%>" class="upload-image"><br>

			<form
				action="<%=request.getContextPath()%>/jp.co.aforce.admin.UpdateProduct.execute"
				...
				<div class="form-select-wrap">
					...
					<table>
						<tr>
							<td>商品ID</td>
							<td><input type="text" name="product_id" class="input-field"
								value="${product.product_id }" onChange="updateValue" required></td>
						</tr>
						<tr>
							<td>商品名</td>
							<td><input type="text" name="product_name"
								class="input-field" value="${product.product_name }"
								onChange="updateValue" required></td>
						</tr>
						<tr>
							<td>価格</td>
							<td><input type="text" name="price" class="input-field"
								value="${product.price }" onChange="updateValue" required></td>
						</tr>
