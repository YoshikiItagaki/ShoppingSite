...
<!-- progress bar -->
    ...
    <div class="middle-container">
       ...
       <div class="input-container">
      	<p style="font-weight:bold; color:red;">本当に商品を削除しますか？</p>
      	<form action="<%= request.getContextPath() %>/jp.co.aforce.admin.DeleteProduct.execute"
      	method="post" class="form" 	name="form" onsubmit="return validateDeletionOnSubmission()">
      		商品ID<input type="text" name="product_id">
			<input type="submit" value="削除する" class="form-button">
      	</form>
      </div>
