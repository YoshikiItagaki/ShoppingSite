...
>
    ...
    <link rel="stylesheet" href="<%= request.getContextPath() %>/css/inputbox-style.css">

    <!-- Dropdown -->
    <link rel="stylesheet" href="<%= request.getContextPath() %>/css/dropdown-style.css">
    <!-- Progress Bar -->
...
<!-- progress bar -->
    ...
    <div class="middle-container">
       ...
       <div class="input-container">
      	<form action="../jp.co.aforce.admin.DeleteProductConfirm.execute" method="post" class="form"
      	name="form" onsubmit="return validateLoginOnSubmission()">

			<p style="font-weight:bold;">登録商品の削除</p>
      		<table>
			...
			<input type="submit" value="削除に進む" class="form-button">
      	</form>
      </div>
...
<!-- js for a progress bar -->
  ...
  <script src="<%= request.getContextPath() %>/js/submission-validation.js" type="text/javascript"></script>
  <script src="<%= request.getContextPath() %>/js/date-input-validation.js" type="text/javascript"></script>
  <script src="<%= request.getContextPath() %>/js/confirmation-window.js" type="text/javascript"></script>


    <script src="<%= request.getContextPath() %>/js/password-validation.js" type="text/javascript"></script>
