...
<html lang="en" dir="ltr">
  <head>
    ...
    <!-- carousel -->
    <link rel="stylesheet" href="<%= request.getContextPath() %>/css/carousel-style.css">
...
<!-- dropdown -->
    ...
    <div class="middle-container">
       ...
       <div class="input-container">
      	<p style="font-weight: bold; color:red; top:300px;">商品の登録に失敗しました。</p>
      	<form action="<%= request.getContextPath() %>/admin-views/admin-add-product-in.jsp" method="post" class="form">
			<input type="submit" value="商品を追加する" class="form-button">
      	</form>
