...
<!-- dropdown -->
	...
	<div class="middle-container">
		...
		<div class="input-container">
			<form action="<%= request.getContextPath() %>/jp.co.aforce.admin.UpdateConfirm.execute"
				method="post" class="form" name="form" id="form"
				onsubmit="return validateLoginOnSubmission()">

				<p style="font-weight: bold;">登録情報の更新</p>
				<table>
				...
				<input type="submit" value="更新" class="form-button">
			</form>
		</div>
