...
<!-- dropdown -->
	...
	<div class="middle-container">
		...
		<div class="input-container">
			<p style="font-weight: bold; margin-left:25%;">管理者情報の確認</p>
			<form action="<%= request.getContextPath() %>/jp.co.aforce.admin.ViewAll.execute" method="post"
				class="form" name="form"
				onsubmit="return validateViewOnSubmission()">
				...
				<input type="submit" value="確認する" class="form-button">
			</form>
		</div>
