...
<!-- dropdown -->
	...
	<div class="middle-container">
		...
		<div class="input-container" style="width: 85%;">
			<p style="font-weight: bold; margin-left: 30%;">全商品の表示</p>
			<form
			...
			<br>
			<form
				action="<%=request.getContextPath()%>/jp.co.aforce.admin.SortProductPriceASC.execute"
				method="post" class="form" name="form" id="search-bar">
				<input type="submit" class="search-button" name="sort" value="価格：昇順">
			</form>
			<br>
			<form
				action="<%=request.getContextPath()%>/jp.co.aforce.admin.SortProductPriceDESC.execute"
				method="post" class="form" name="form" id="search-bar">
				<input type="submit" class="search-button" name="sort" value="価格：降順">
			</form>
			<br>
			<form
				action="<%=request.getContextPath()%>/jp.co.aforce.admin.DisplayAllProducts.execute"
				method="post" class="form" name="form" id="search-bar">
