...
<!-- dropdown -->
	...
	<div class="middle-container">
		...
		<div class="input-container">
			<div>
				<p style="font-weight: bold;">新たに登録する情報を入力してください。</p>
				<form
					action="<%=request.getContextPath()%>/jp.co.aforce.admin.Register.execute"
					method="post" name="form" class="form" id="form"
					onsubmit="return validateRegistrationOnSubmission()">
					<!-- onsubmit="return validateRegistrationOnSubmission()" -->
					<div class="form-select-wrap">
						...
						<table>
							...
							<tr>
								<td>性別</td>
								<td><input type="radio" name="sex" id="male" value="1"> <label
									for="male">男</label> <input type="radio" name="sex" id="female" value="2">
	...
	<script
		src="https://cdnjs.cloudflare.com/ajax/libs/libphonenumber-js/1.1.10/libphonenumber-js.min.js"></script>
