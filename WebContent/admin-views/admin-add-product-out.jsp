...
<!-- progress bar -->
    ...
    <div class="middle-container">
      ...
      <div class="input-container">
			...
			<p style="font-weight: bold;">商品の登録に成功しました。</p>

      	<form action="<%= request.getContextPath() %>/admin-views/admin-index.jsp" method="post" class="form">
			<input type="submit" value="トップページ" class="form-button">
      	</form>
      </div>
