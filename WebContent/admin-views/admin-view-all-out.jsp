...
<!-- dropdown -->
	...
	<div class="middle-container">
		...
		<%@page import="jp.co.aforce.bean.Customer"%>


		<div class="input-container">
			<p style="font-weight: bold;">管理者情報</p>
			<div>
				<table style="margin-left: 20%;">
					...
					<tr>
						<td>生年月日:年</td>
						<td>${admin.birth_year}</td>
					</tr>
					<tr>
						<td>生年月日:月</td>
						<td>${admin.birth_month }</td>
					</tr>
					<tr>
						<td>生年月日:日</td>
			...
			<form
				action="<%= request.getContextPath() %>/admin-views/admin-index.jsp"
				method="post" class="form">
				<input type="submit" value="ホーム" class="form-button">
			</form>
		</div>
