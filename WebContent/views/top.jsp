...
<body>
	...
	<div class="top-container">
		...
		<p class="welcome-header">HANGOVERへようこそ！</p>
	...
	<div class="middle-container">
		...
		<div class="sign-in-container">
			...
			<table class="sign-in-table">
				<tr>
					<td>
						<form action="<%= request.getContextPath() %>/views/register-in.jsp"
							method="post" class="form">
							<input type="submit" value="ユーザー登録" class="form-button"
								style="width: 105px;">
						</form>
					</td>
					<td>
						<form action="<%=request.getContextPath()%>/views/login-in.jsp"
							method="post" class="form">
							<input type="submit" value="ユーザーログイン" class="form-button"
								style="width: 105px;">
						</form>
					</td>
					<td>
						<form
							action="<%= request.getContextPath() %>/admin-views/admin-login-in.jsp"
							method="post" class="form">
							<input type="submit" value="管理者ログイン" class="form-button"
								style="width: 105px;">
						</form>
