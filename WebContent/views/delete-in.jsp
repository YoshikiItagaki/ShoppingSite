...
<body>
	...
	<div class="middle-container">
		...
		<div class="input-container">
			<p style="font-weight: bold; color: red;">本当に登録情報を削除しますか？</p>
			<form
				action="<%= request.getContextPath() %>/jp.co.aforce.user.Delete.execute"
				method="post" class="form" name="form"
				onsubmit="return validateDeletionOnSubmission()">
				<input type="hidden" name="id" value="${customer.id }"> <input
					type="hidden" name="password" value="${customer.password }">
