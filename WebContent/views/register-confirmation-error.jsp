...
<body>
	...
	<div class="middle-container">
		...
		<div class="input-container">
			<p style="font-weight: bold; color: red;">すでにアカウントが登録されています。</p>
			<form action="<%= request.getContextPath() %>/views/login-in.jsp" method="post" class="form">
				<input type="submit" value="ログインする" class="form-button">
			</form>
