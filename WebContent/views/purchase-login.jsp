...
<body>
	...
	<div class="middle-container">
		...
		<div class="input-container">
			<p style="font-weight: bold;">ログインして購入に進む</p>
			<form action="<%=request.getContextPath()%>/jp.co.aforce.user.PurchaseConfirm.execute" method="post"
				class="form" name="form" id="form"
				onsubmit="return validateLoginOnSubmission()">
		...
		<nav class="menu-container">
			<ul>
				<li class="has-child"><a href="#">アカウント</a>
					<ul>
						<li><a
							href="<%=request.getContextPath()%>/views/login-in.jsp"><dl>
									<dt>
										<img src="" alt="">
									</dt>
									<dd>ログイン</dd>
				...
				<li class="has-child"><a href="product.html">商品</a>
					<ul>
						<li><a href="#"><dl>
									<dt>
										<img src="" alt="">
				...
				<li class="has-child"><a
					href="<%=request.getContextPath()%>/views/login-in.jsp">購入</a></li>

				<li class="has-child"><a
					href="<%=request.getContextPath()%>/views/login-in.jsp">カート</a></li>
			</ul>
		</nav>
