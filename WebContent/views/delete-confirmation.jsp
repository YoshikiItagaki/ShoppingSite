...
<body>
	...
	<!-- <form action="../jp.co.aforce.action.Login.execute" method="post" class="login">
		パス -->
	...
	<div class="middle-container">
		...
		<div class="input-container">
			<form action="<%= request.getContextPath() %>/jp.co.aforce.user.DeleteConfirm.execute"
				method="post" class="form" name="form" id="form"
				onsubmit="return validateLoginOnSubmission()">

				<p style="font-weight: bold;">アカウント削除</p>
				<table>
				...
				<input type="submit" value="削除" class="form-button">
			</form>
		</div>
