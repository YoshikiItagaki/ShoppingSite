...
<body>
	...
	<div class="middle-container">
		...
		<div class="input-container">
			<form action="../jp.co.aforce.user.Logout.execute" method="post"
				class="form" name="form" id="form"
				onsubmit="return validateLogoutOnSubmission()">

				<p style="font-weight: bold;">ログアウト</p>
				<table>
				...
				<input type="submit" value="ログアウト" class="form-button">
			</form>
		</div>
	</div>
	...
	<!--  js for dropdown -->
	<script src="<%=request.getContextPath()%>/js/dropdown.js" type="text/javascript">
	...
	<script
		...
		type="text/javascript"></script>
	<script
		src="<%=request.getContextPath()%>/js/password-validation.js"
		type="text/javascript"></script>
