...
<body>
	...
	<div class="middle-container">
		...
		<div class="input-container">
			<form
				action="<%=request.getContextPath()%>/jp.co.aforce.user.CheckPurchaseHistory.execute"
				method="post" class="form" id="form" onsubmit="return validateCheckHistoryOnSubmission()">
				<p>購入履歴を見る
				<table>
				...
				<input type="submit" value="購入履歴を見る" class="form-button">
			</form>
		</div>
	...
	<script src="<%=request.getContextPath()%>/js/check-history-validation.js"
		type="text/javascript"></script>
