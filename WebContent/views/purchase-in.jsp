...
<body>
	...
	<div class="middle-container">
		...
		<div class="input-container">
			<p style="font-weight: bold;">${item.product.product_id}</p>

			<table>
				<c:forEach var="item" items="${cart}">
					<tr>
						<td>商品${item.product.product_id }
						</td>
						<td><img
							src="<%= request.getContextPath() %>/img/${item.product.product_id}.jpg"
			...
			<p>基本情報の確認</p>
			<form
				action="<%=request.getContextPath()%>/jp.co.aforce.user.Purchase.execute"
				onsubmit="return validatePurchaseOnSubmission()">
				...
				<table>
					...
					<tr>
						<td><input type="hidden" name="address" value="${customer.address }"></td>
					</tr>
					<tr>
						<td><input type="hidden" name="email" value="${customer.email }"></td>
					</tr>
					<tr>
						<td><input type="hidden" name="id" value="${customer.id }"></td>
					</tr>
					<tr>
						<td><input type="hidden" name="password" value=	"${customer.password }"></td>
					</tr>
					<tr>
						<td><input type="hidden" name="sex" value=	"${customer.sex }"></td>
					</tr>
					<tr>
						<td><input type="hidden" name="birth_year" value=	"${customer.birth_year }"></td>
					</tr>
				</table>
				<input type="submit" value="購入を確定" class="form-button">
			</form>
...
<script
		src="<%=request.getContextPath()%>/js/submission-validation.js"
		type="text/javascript"></script>
	<script
		src="<%=request.getContextPath()%>/js/date-input-validation.js"
		type="text/javascript"></script>
